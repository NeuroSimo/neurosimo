...
2. Installation Configuration
   ...
   - Do not update installer during installation
   - Connect to the internet when asked
   - Select "Interactive installation"
   - Enable:
     - Install third-party software for graphics and Wi-Fi hardware
   - Select "Default selection" for software to install
   - Select "Manual installation" for disk setup
