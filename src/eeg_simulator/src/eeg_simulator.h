...
private:
  ...
  rclcpp::Publisher<neurosimo_eeg_interfaces::msg::Sample>::SharedPtr eeg_publisher;
  ...
  rclcpp_action::Server<neurosimo_eeg_interfaces::action::InitializeSimulatorStream>::SharedPtr initialize_action_server;
