...
#include "eeg_interfaces/srv/initialize_eeg_replay_stream.hpp"
...
private:
  void global_config_callback(const system_interfaces::msg::GlobalConfig::SharedPtr msg);
  ...
  rclcpp::Publisher<system_interfaces::msg::DataSourceState>::SharedPtr state_publisher_;
  rclcpp::Client<system_interfaces::srv::AbortSession>::SharedPtr abort_session_client_;
  rclcpp::Subscription<system_interfaces::msg::GlobalConfig>::SharedPtr global_config_sub_;

  rclcpp::Service<eeg_interfaces::srv::InitializeEegReplayStream>::SharedPtr initialize_service_;
  rclcpp::Service<eeg_interfaces::srv::StartStreaming>::SharedPtr start_streaming_service_;
  rclcpp::Service<eeg_interfaces::srv::StopStreaming>::SharedPtr stop_streaming_service_;

  system_interfaces::msg::GlobalConfig::SharedPtr global_config_;
  bool is_initialized_ = false;
  std::string bag_filepath_;
  bool play_preprocessed_ = false;
  eeg_interfaces::msg::StreamInfo stream_info_;
