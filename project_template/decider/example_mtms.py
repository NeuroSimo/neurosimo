...
class Decider:
    ...
    def __init__(self, num_of_eeg_channels, num_of_emg_channels, sampling_frequency):
        ...
        # is 5000 samples, so with a sampling frequency of 5000 Hz, implying that performing the trial every 2 process calls
        # is equivalent to performing it every two seconds.)
    ...
    def get_configuration(self):
        ...
        return {
            # Call 'process' method once every second if the sampling rate is 5 kHz.
            'processing_interval_in_samples': 5000,
