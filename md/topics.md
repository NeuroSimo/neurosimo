...
- `/neurosimo/pipeline/attempt_trace` - Attempt trace stream (intermediate, enriched by pipeline stages).
- `/neurosimo/pipeline/attempt_trace/final` - Finalized attempt trace output.
