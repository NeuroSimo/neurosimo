...
#include "neurosimo_project_interfaces/srv/get_dataset_info.hpp"
#include "neurosimo_project_interfaces/msg/dataset_info.hpp"
...
public:
  ...
  std::tuple<bool, neurosimo_project_interfaces::msg::DatasetInfo, std::vector<double_t>> get_dataset_info(
...
private:
  ...
  std::tuple<bool, std::vector<double_t>> read_event_times_from_csv(const std::string& event_file_path);
  ...
  rclcpp::Node* node_;
  rclcpp::Service<neurosimo_project_interfaces::srv::GetDatasetInfo>::SharedPtr service_;
